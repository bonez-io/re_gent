...
const meta = { component: ProjectSidebar, tags: ['ai-generated'], parameters: { layout: 'centered' } } satisfies Meta<typeof ProjectSidebar>
export default meta
...
export const CssCheck: Story = {
  ...
  play: async ({ canvas }) => {
    ...
    await expect(getComputedStyle(sidebar).backgroundColor).toBe('rgb(255, 255, 255)')
  },
}
