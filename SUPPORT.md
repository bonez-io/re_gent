...
- **POC.md** - Technical specification, architecture decisions
- **TESTING.md** - Testing strategy and manual test procedures
- **BRAND.md** - CLI design, visual identity, tone guidelines
...
- **Discussions**: Responses within 1-3 days
- **Issues**: Triage within 1 week
- **PRs**: Initial review within 1 week
- **Security**: Acknowledgment within 48 hours
